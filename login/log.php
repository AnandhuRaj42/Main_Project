		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					STOCK AND MAINTENANCE MANAGEMENT
				</span>

				<form class="login100-form validate-form p-b-33 p-t-5" action="login_check.php" method="post">

					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="email" name="email" required="" autocomplete="off" placeholder="User name" id="myInput">
